                        ...
                        .show(ui, |ui| {
                            ui.vertical_centered(|ui| {
                                ...
                                if
                                    delete_button
                                        .on_hover_text(
                                            "⚠️ This will permanently delete all clipboard entries"
                                        )
                                        .clicked()
                                {
            ...
            egui::Window
                ...
                .show(ctx, |ui| {
                    ...
                    ui.vertical_centered(|ui| {
                        ...
                        ui.label(
                            RichText::new("⚠️").size(32.0).color(Color32::from_rgb(239, 68, 68))
                        );
                        ui.add_space(8.0);

                        ui.label(
                            RichText::new("Are you sure you want to delete all records?")
                                .size(14.0)
                                .color(Color32::WHITE)
                        );
